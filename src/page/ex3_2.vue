<template>
    <div class="fillcontain">
        ...
        <header class="admin_title">添加老师</header>

        <el-form class="form_contianer" :model="data" ref="ChangeForm">
            <el-form-item prop="tid">
                <el-input v-model="data.tid" placeholder="教师编号"><span>dsfsf</span></el-input>
            </el-form-item>
...
<script>
    ...
    import {insertStudnet, insertTeacher} from '../api/getData'
