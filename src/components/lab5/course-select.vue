...
<template>
  <div>
    <el-input v-model="sid" placeholder="请输入学号"
              style="float: left; width: 15%; padding: 20px; margin-left: 30px"></el-input>
    ...
    <el-table :data="tableData" highlight-current-row :border="true" :stripe="true" v-show="table1show"
              style="width: 100%">
      <el-table-column property="cid" label="课程号"></el-table-column>
      <el-table-column property="cname" label="课程名"></el-table-column>
      <el-table-column property="tid" label="教师编号"></el-table-column>
      <el-table-column property="tname" label="教师姓名"></el-table-column>
      <el-table-column property="score" label="得分"></el-table-column>
      <el-table-column label="更新" width="180">
        <template slot-scope="props">
          <el-button type="success" @click="editShow(props.row,props.$index)">更新</el-button>
        </template>
      </el-table-column>
    </el-table>
    <div style="clear: both"></div>
    <header v-show="table2show" class="admin_title">可选课程</header>
    <el-table :data="tableData2" highlight-current-row :border="true" :stripe="true" v-show="table2show"
              style="width: 100%">
      <el-table-column property="cid" label="课程号"></el-table-column>
      ...
      <el-table-column label="选课" width="180">
        <template slot-scope="props">
          <el-button type="success" @click="chooseCourse(props.row)">选课</el-button>
        </template>
      </el-table-column>
    </el-table>
